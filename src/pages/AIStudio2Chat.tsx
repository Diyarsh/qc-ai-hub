...
export default function AIStudio2Chat() {
  const {
    t
  } = useLanguage();
  ...
  return <div className="flex flex-col h-screen">
      <PageHeader title="AI-Studio 2" subtitle="Вариант с сайдбаром слева" />
      <main className="flex-1 flex min-h-0">
        {/* Agent History Sidebar - слева, только если выбран агент */}
        {agent && (
          <AgentHistorySidebar
            agentId={agent}
